 ...
 */
class DroppyMenuItemIconView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = R.attr.droppyMenuItemIconStyle
    ...
    init {
        ...
        val maxWidth =
            a.getDimension(R.styleable.DroppyMenuItemIconView_android_maxWidth, defaultMaxWidth.toFloat()).toInt()
        val maxHeight =
            a.getDimension(R.styleable.DroppyMenuItemIconView_android_maxHeight, defaultMaxHeight.toFloat()).toInt()
        val width = a.getLayoutDimension(
            R.styleable.DroppyMenuItemIconView_android_layout_width,
            ViewGroup.LayoutParams.WRAP_CONTENT
        )
        val height = a.getLayoutDimension(
            R.styleable.DroppyMenuItemIconView_android_layout_height,
            ViewGroup.LayoutParams.WRAP_CONTENT
        )

        val lp = LinearLayout.LayoutParams(width, height)
        lp.rightMargin =
            a.getDimensionPixelSize(R.styleable.DroppyMenuItemIconView_android_layout_marginRight, defaultMarginRight)
        lp.leftMargin =
            a.getDimensionPixelSize(R.styleable.DroppyMenuItemIconView_android_layout_marginLeft, defaultMarginLeft)
        lp.width = width
        lp.height = height
