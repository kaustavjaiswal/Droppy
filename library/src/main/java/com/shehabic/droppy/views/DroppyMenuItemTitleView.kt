 ...
 */
class DroppyMenuItemTitleView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = R.attr.droppyMenuItemTitleStyle) : AppCompatTextView(context, attrs, defStyleAttr) {
    ...
    init {
        ...
        val minWidth = a.getDimension(R.styleable.DroppyMenuItemTitleView_android_minWidth, defaultMinWidth.toFloat()).toInt()
        val minHeight = a.getDimension(R.styleable.DroppyMenuItemTitleView_android_minHeight, defaultMinHeight.toFloat()).toInt()
        val width = a.getLayoutDimension(R.styleable.DroppyMenuItemTitleView_android_layout_width, defaultWidth)
        val height = a.getLayoutDimension(R.styleable.DroppyMenuItemTitleView_android_layout_height, ViewGroup.LayoutParams.WRAP_CONTENT)
